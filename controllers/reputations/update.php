...
<ul>
    <li><a href="<?= Backend::url('voilaah/gamify/reputations') ?>">Reputations</a></li>
        ...
        <div class="loading-indicator-container">
            ...
            <span class="btn-text">
                <?= e(trans('backend::lang.form.or')) ?> <a
                    href="<?= Backend::url('voilaah/gamify/reputations') ?>"><?= e(trans('backend::lang.form.cancel')) ?></a>
            </span>
        </div>
    </div>
...
<?php else: ?>
    ...
    <p><a href="<?= Backend::url('voilaah/gamify/reputations') ?>"
